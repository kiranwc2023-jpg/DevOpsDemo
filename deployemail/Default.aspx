            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
                        ...
                        <asp:ListItem>US-Production</asp:ListItem>
                        <asp:ListItem>EU-Production</asp:ListItem>
                    </asp:DropDownList>
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please Select Envirnoment" ControlToValidate="DropDownList1" Font-Bold="True" Font-Italic="True"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="style2">
